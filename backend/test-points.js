...
const testCases = [
  ...
  {
    name: 'Chấp 0.5 - Chọn cửa trên và cửa trên thắng (1-0) -> Thắng kèo (Đúng) -> 0 điểm',
  ...
  {
    name: 'Chấp 0.5 - Chọn cửa trên và hòa (1-1) -> Thua kèo (Sai) -> 1 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 1,
    awayScore: 1,
    handicap: { team: 'home', value: 0.5 },
  ...
  {
    name: 'Chấp 0.5 - Chọn cửa dưới và hòa (1-1) -> Thắng kèo (Đúng) -> 0 điểm',
  ...
  {
    name: 'Chấp 0.25 - Chọn cửa trên và cửa trên thắng (1-0) -> Thắng kèo full (Đúng) -> 0 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 1,
    awayScore: 0,
  ...
  {
    name: 'Chấp 0.25 - Chọn cửa trên và hòa (0-0) -> Thua nửa kèo (Sai) -> 1 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 0,
    awayScore: 0,
    handicap: { team: 'home', value: 0.25 },
  ...
  {
    name: 'Chấp 0.25 - Chọn cửa dưới và hòa (0-0) -> Ăn nửa tiền (Đúng) -> 0 điểm',
    pred: { predictedHandicapWinner: 'away' },
    homeScore: 0,
    awayScore: 0,
    handicap: { team: 'home', value: 0.25 },
  ...
  {
    name: 'Chấp 0.75 - Chọn cửa trên và cửa trên thắng 1 bàn (1-0) -> Ăn nửa kèo (Đúng) -> 0 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 1,
    awayScore: 0,
  ...
  {
    name: 'Chấp 0.75 - Chọn cửa trên và cửa trên thắng 2 bàn (2-0) -> Thắng kèo full (Đúng) -> 0 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 2,
    awayScore: 0,
    handicap: { team: 'home', value: 0.75 },
  ...
  {
    name: 'Chấp 0.75 - Chọn cửa dưới và cửa trên thắng 1 bàn (1-0) -> Thua nửa kèo (Sai) -> 1 điểm',
    pred: { predictedHandicapWinner: 'away' },
    homeScore: 1,
    awayScore: 0,
    handicap: { team: 'home', value: 0.75 },
  ...
  {
    name: 'Chấp 1.0 - Chọn cửa trên và cửa trên thắng 1 bàn (2-1) -> Hòa kèo (Sai) -> 1 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 2,
    awayScore: 1,
  ...
  {
    name: 'Chấp 1.0 - Chọn cửa trên và cửa trên thắng 2 bàn (2-0) -> Thắng kèo full (Đúng) -> 0 điểm',
    pred: { predictedHandicapWinner: 'home' },
    homeScore: 2,
    awayScore: 0,
    handicap: { team: 'home', value: 1.0 },
